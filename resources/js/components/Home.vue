    ...
    <div class="container">     
            <div class="tab-content">
                <div id="home" class="tab-pane fade show active">
                        ...
                        <div class="col-md-11">
                            ...
                            <card-component titulo="Busca de pessoas">
                                <template v-slot:conteudo>
                                        ...
                                        <div class="col mb-3">
                                            <input-container-component titulo="Nome" id="inputNome" id-help="nomeHelp">
                                                <input type="text" class="form-control" id="inputNome"
                                                    aria-describedby="nomeHelp" placeholder="Digite o nome pessoa"
                                                    v-model="busca.nome">
                                        ...
                                        <div class="col mb-3">
                                            <input-container-component titulo="CPF" id="inputCPF" id-help="CPFHelp">
                                                <input type="number" class="form-control" id="inputCPF"
                                                    aria-describedby="idHelp" placeholder="Digite o CPF"
                                                    v-model="busca.CPF">
                                            </input-container-component>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col mb-3">
                                            <input-container-component titulo="Inicio" id="inputdatainicio" id-help="datainicioHelp">
                                                <input type="date" class="form-control" id="inputDatainicio"
                                                    aria-describedby="datainicioHelp"
                                                    v-model="busca.datainicio">
                                            </input-container-component>
                                        </div>
                                        <div class="col mb-3">
                                            <input-container-component titulo="Fim" id="inputdatafim" id-help="datafimHelp">
                                                <input type="date" class="form-control" id="inputDatafim"
                                                    aria-describedby="datafimHelp"
                                                    v-model="busca.datafim">
                                            </input-container-component>
                                        </div>
                                    </div>
                                </template>
                            ...
                            <card-component titulo="Relação de pessoas">
                                <template v-slot:conteudo>
                                    <table-component :dados="pessoas.data"
                                        :detalhar="{ visivel: true, dataToggle: 'modal', dataTarget: '#modalPessoaDetalhar'}"
                                        :editar="{ visivel: true,  dataToggle: 'tab', dataTarget: '#modalPessoaEditar' }"
                    ...
                    <div id="modalPessoaEditar" titulo="Editar pessoa" class="tab-pane fade ">
                        
                        
                            <input-container-component titulo="Nome da pessoa" id="novoNome" id-help="novoNomeHelp"
                                texto-ajuda="Informe o nome da pessoa">
                                <input type="text" class="form-control" id="novoNome" aria-describedby="novoNomeHelp"
                                    placeholder="Nome da pessoa" v-model="$store.state.item.nome">
                            </input-container-component>

                            <input-container-component titulo="CPF da pessoa" id="novoCpf" id-help="novoCpfHelp"
                                texto-ajuda="Informe o CPF da pessoa">
                                <input type="text" class="form-control" id="novoCpf" aria-describedby="novoCpfHelp"
                                    placeholder="CPF da pessoa" v-model="$store.state.item.CPF">
                            </input-container-component>

                            <input-container-component titulo="E-mail da pessoa" id="novoEmail" id-help="novoEmailHelp"
                                texto-ajuda="Informe o e-mail da pessoa">
                                <input type="text" class="form-control" id="novoEmail" aria-describedby="novoEmailHelp"
                                    placeholder="E-mail da pessoa" v-model="$store.state.item.email">
                            </input-container-component>

                            <input-container-component titulo="Perfil da pessoa" id="novoPerfil"
                                id-help="novoPerfilHelp" texto-ajuda="Informe o perfil da pessoa">
                                <input type="text" class="form-control" id="novoPerfil"
                                    aria-describedby="novoPerfilHelp" placeholder="Perfil da pessoa"
                                    v-model="$store.state.item.perfil">
                            </input-container-component>
